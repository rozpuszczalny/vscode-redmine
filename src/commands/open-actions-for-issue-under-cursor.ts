...
function getTextUnderCursor(editor: vscode.TextEditor): string {
    ...
    if (currentSelection.isEmpty) {
        ...
        if(cursorWordRange) {
            const newSelection = new vscode.Selection(cursorWordRange.start.line, cursorWordRange.start.character, cursorWordRange.end.line, cursorWordRange.end.character);
